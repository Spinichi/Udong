...
| Name      | Role        | Main Field |
| :-------- | :---------- | :--------- |
| **이희준**    | **Team Lead** | **Frontend**   |
| 김성민    | Team Member | Infra      |
| 성호준    | Team Member | Frontend   |
| 박정현    | Team Member | Frontend   |
| 김민정    | Team Member | Backend    |
| 진성범    | Team Member | Backend    |
